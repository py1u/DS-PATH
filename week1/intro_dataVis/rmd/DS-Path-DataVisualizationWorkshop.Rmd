...
Lastly, you need to communicate your results! It doesn’t matter how great your analysis is unless you can explain it to others.
...
hist(x = mpg$hwy, main = "Highways", xlab = "Highways", ylab = "Frenquecy")

hist(x = mpg$hwy, breaks = 5, main = "Highways", xlab = "Highways", ylab = "Frenquecy")

hist(x = mpg$hwy, breaks = 15, main = "Highways", xlab = "Highways", ylab = "Count")

#the change in breaks changes the number of breaks across the distribution
```
...
```{r}
# insert code here
boxplot(x = mpg$hwy, main = "Number of Highways Distribution" ,data = mpg,xlab = "Highways", ylab = "MPG", col = "red")
```
...
boxplot(mpg$cty ~ mpg$drv,
        main = "Miles per Gallon by Number of Cylinders",
        xlab = "Number of Cylinders", ylab = "Miles per Gallon",
        col = "grey", border = "blue", horizontal = TRUE)
```
...
```{r}
# insert code here
plot(x = mpg$hwy, y = mpg$cty, main = "Scatter Plot For City Mileage vs Highway Mileage")
```
...
# insert code here
plot(x = mpg$hwy, y = mpg$cty, main = "Scatter Plot For City Mileage vs Highway Mileage")
abline(a = 0.8442, b = 0.6832, lwd = 2, col = "red")
```
...
```
```{r}
drive_types = c("Four Wheel", "Rear Wheel", "Forward Wheel")
barplot(drive_counts, names.arg = drive_types)
```
